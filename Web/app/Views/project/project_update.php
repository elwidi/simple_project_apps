            ...
            <div class="card-body">
                <form method = "POST" action = "<?= base_url('project/store')?>">
                    <div class="form-group">
                        ...
                        <input class="form-control mb-3" type="text" name = "project_name" value = "<? echo $project['project_name']; ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<? echo date('d-m-Y', strtotime($project['start_date']));?>" name = "start_date">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<? echo date('d-m-Y', strtotime($project['end_date']));?>" name = "end_date">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="simpleDataInput">Description</label>
                        <textarea class="form-control mb-3" name = "description"><? echo $project['description']; ?></textarea>
                    </div>
